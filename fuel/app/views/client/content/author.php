	...
	<nav aria-label="breadcrumb" class="mb-4">
		<ol class="breadcrumb" style="background: transparent;">
			...
			<li class="breadcrumb-item active" aria-current="page" style="color: #94a3b8;">
				Tác giả: <?php echo Security::htmlentities($author->name); ?>
			</li>
		</ol>
	</nav>
				...
				<div class="card-body">
					<div class="d-flex align-items-center gap-3 flex-wrap">
						<div class="flex-shrink-0">
							<div style="width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg, var(--primary-color), var(--primary-dark)); display: flex; align-items: center; justify-content: center; color: white; font-size: 2rem; font-weight: bold;">
						...
						<div class="flex-grow-1">
							...
							<p class="mb-0" style="color: #94a3b8;">
								<?php echo number_format($total_stories); ?> truyện đã đăng
							</p>
						</div>
					</div>
				</div>
			...
			<nav aria-label="Author pagination">
				<ul class="pagination justify-content-center">
					...
					<?php if ($current_page > 1): ?>
						<li class="page-item">
							<a class="page-link" href="<?php echo Uri::base(); ?>client/author/<?php echo $author->slug; ?>?page=<?php echo $current_page - 1; ?>">
					...
					if ($start_page > 1): ?>
						<li class="page-item">
							<a class="page-link" href="<?php echo Uri::base(); ?>client/author/<?php echo $author->slug; ?>?page=1">1</a>
						</li>
						<?php if ($start_page > 2): ?>
							<li class="page-item disabled">
					...
					<?php for ($i = $start_page; $i <= $end_page; $i++): ?>
						<li class="page-item <?php echo ($i == $current_page) ? 'active' : ''; ?>">
							<a class="page-link" href="<?php echo Uri::base(); ?>client/author/<?php echo $author->slug; ?>?page=<?php echo $i; ?>">
								<?php echo $i; ?>
							</a>
						</li>
					<?php endfor; ?>
					...
					<?php if ($end_page < $total_pages): ?>
						...
						<?php endif; ?>
						<li class="page-item">
							<a class="page-link" href="<?php echo Uri::base(); ?>client/author/<?php echo $author->slug; ?>?page=<?php echo $total_pages; ?>">
	...
	<div class="card">
		<div class="card-body text-center py-5">
			...
			<p class="text-muted mb-4" style="color: #94a3b8;">
				Tác giả này chưa có truyện nào được đăng.
			</p>
