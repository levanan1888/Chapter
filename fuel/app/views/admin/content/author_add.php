...
<div class="card">
	<div class="card-body">
		...
		<form method="POST" action="<?php echo Uri::base(); ?>admin/authors/add" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="slug" name="slug" 
							   value="<?php echo isset($form_data['slug']) ? htmlspecialchars($form_data['slug']) : ''; ?>"
							   placeholder="Tự động tạo từ tên tác giả">
						<div class="form-text">Slug sẽ được tự động tạo từ tên tác giả nếu để trống</div>
					</div>
				...
				<div class="col-md-4">
					<div class="mb-3">
						...
						<?php if (isset($form_data['avatar']) && !empty($form_data['avatar'])): ?>
							<div class="mt-2">
								<img src="<?php echo Uri::base() . htmlspecialchars($form_data['avatar']); ?>" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;">
							</div>
						<?php endif; ?>
					</div>
			...
			<div class="d-flex justify-content-end gap-2">
				...
				<button type="submit" class="btn btn-primary">
					<i class="fas fa-save me-2"></i>Lưu tác giả
				</button>
			</div>
		</form>
	</div>
